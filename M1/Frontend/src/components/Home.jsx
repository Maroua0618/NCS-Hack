...
const Home = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden relative">
      <div className="bg-purple-50 text-black py-20 md:py-32 text-center md:text-left relative overflow-hidden min-h-screen flex items-center">
        <div className="container mx-auto px-4 relative z-10 max-w-6xl">
          <div>
            <h1 className="font-black text-5xl sm:text-6xl md:text-8xl mb-2 leading-tight text-purple-600 text-left ml-4 md:ml-0">
              StudyMate
            </h1>
          </div>
          <div>
          ...
          <div>
            <div className="flex gap-6 justify-center md:justify-start flex-wrap mb-8 ml-4 md:ml-0">
              <button
                className="bg-purple-600 text-white px-8 py-4 text-xl font-bold rounded-2xl shadow-lg hover:bg-gray-100 hover:text-purple-600 hover:scale-105 hover:-translate-y-1 transition-all duration-300 flex items-center gap-2"
              ...
              <button
                className="border-2 border-purple-600 text-black px-8 py-4 text-xl font-bold rounded-2xl backdrop-blur-sm hover:bg-white/20 hover:scale-105 hover:-translate-y-1 transition-all duration-300 flex items-center gap-2"
                onClick={() => navigate('/login')}
              >
      ...
      <div className="py-8 bg-purple-50 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 max-w-6xl">
          <div className="flex justify-around items-center flex-wrap gap-8 py-8">
            <div className="text-center flex items-center gap-4">
              <h2 className="text-purple-600 font-black text-5xl md:text-7xl">95%</h2>
              <div className="w-1 h-16 bg-purple-600 rounded hidden md:block" />
              <p className="text-black font-semibold text-lg text-left">success rate</p>
            </div>
            <div className="text-center flex items-center gap-4">
              <h2 className="text-purple-600 font-black text-5xl md:text-7xl">50k+</h2>
              <div className="w-1 h-16 bg-purple-600 rounded hidden md:block" />
              <p className="text-black font-semibold text-lg text-left">students</p>
            </div>
            <div className="text-center flex items-center gap-4">
              <div className="flex items-center gap-2">
                <h2 className="text-purple-600 font-black text-5xl md:text-7xl">4.9</h2>
      ...
      <div className="py-12 bg-purple-50 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 max-w-6xl">
